    ...
    stages {
        stage('Build') {
            steps {
                ...
                docker build -t zoharn007-repo:0.0.$BUILD_NUMBER .
                docker tag zoharn007-repo:0.0.$BUILD_NUMBER 352708296901.dkr.ecr.eu-west-1.amazonaws.com/zoharn007-repo:0.0.$BUILD_NUMBER
